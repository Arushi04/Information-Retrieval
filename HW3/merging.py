...
def main(args):
    ...
    for file in os.listdir(args.cdp):
        ...
        #logging.info("Checking for result {}".format(result))
        ...
        if result['found'] is True:
            ...
            es2.update(index=args.out_index, id=url, body={"doc": {"inlinks": json.dumps(final_inlinkset)}})
            filesupdated += 1
            ...
            es2.index(index=args.out_index, id=url, body=doc)
            filesadded += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument('-out', '--out_index', type=str, default="ir_hw03_prod", help="")
